...
| ------ | ------ | ------ | ------ |
| <a id="publicclient"></a> `publicClient?` | `readonly` | \{ \} | [src/v4/index.ts:32](https://github.com/clanker-devco/clanker-sdk/blob/main/src/v4/index.ts#L32) |
| <a id="wallet"></a> `wallet?` | `readonly` | \{ \} | [src/v4/index.ts:31](https://github.com/clanker-devco/clanker-sdk/blob/main/src/v4/index.ts#L31) |
