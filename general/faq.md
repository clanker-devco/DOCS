...
On the Clanker token homepage, you can:

* Search for tokens by token name, ticker, or Farcaster username of the creator.
* Use the Connect button on the bottom left of the page to connect the wallet of your verified address, then press my deployed clankers.
* Visit the deployed by FID page and type in your FID. See  for guidance on finding your FID.
...
* Your latest Farcaster verified address
* Your Farcaster custody address (if you do not have any Farcaster verified addresses)

See  for guidance on finding your creator rewards address.
...
Watch this video here: [https://x.com/JackDishman/status/2021651772016931161](https://x.com/JackDishman/status/2021651772016931161)​
