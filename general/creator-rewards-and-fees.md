...
Creator rewards can be claimed on the Admin page of the token on clanker.world. The admin page can be found at [https://www.clanker.world/clanker/TOKEN\_CONTRACT\_ADDRESS\_HERE/admin](https://www.clanker.world/clanker/TOKEN_CONTRACT_ADDRESS_HERE/admin) .

Please see the  for detail on finding Token Info pages and collecting creator rewards.
